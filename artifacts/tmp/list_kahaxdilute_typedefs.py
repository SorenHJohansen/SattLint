...
Path("/home/sqhj/projects/SattLint/artifacts/tmp/list_kahaxdilute_typedefs.txt").write_text(
    "\n".join(sorted(mt.name for mt in project_bp.moduletype_defs or []))
)
print(len(project_bp.moduletype_defs or []))
