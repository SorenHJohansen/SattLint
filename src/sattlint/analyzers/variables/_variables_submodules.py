...
def _walk_moduletype_instance_subtree(  # noqa: PLR0915
    self: VariablesAnalyzer,
...
class VariablesSubmodulesMixin:
    def _should_walk_submodule_path(self: Any, child_path: list[str]) -> bool:
        return _should_walk_submodule_path(self, child_path)
    ...
    def _display_path_for_child(
        ...
        return _display_path_for_child(self, child, parent_context)
    ...
    def _walk_submodules(
        ...
        _walk_submodules(self, children, parent_context, parent_path)
    ...
    def _lookup_env_var_from_varname_dict(
        ...
        return _lookup_env_var_from_varname_dict(self, var_dict_or_other, env)

    def _detect_datatype_duplications(self: Any) -> None:
        _detect_datatype_duplications(self)
