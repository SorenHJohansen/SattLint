...
from ..framework import AnalysisSharedArtifacts, AnalyzerLifecycleMixin, Issue, SimpleReport
...
class DataflowAnalyzer(
    ...
    def __init__(
        ...
        self._initialize_lifecycle(trace_namespace="dataflow", status_prefix="Analyzing dataflow")
