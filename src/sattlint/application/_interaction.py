...
"""Shared application-level console interaction defaults.

Interactive actions and menus receive a :class:`sattlint.app_interaction.MenuInteraction`
as an injectable prompt/confirm/pause/choose-menu abstraction.  This module
holds the default interaction built from the standard console helpers so the
application layer never depends on a concrete terminal by itself.
"""
...
from ..app_base import choose_menu_option, confirm, pause, prompt
