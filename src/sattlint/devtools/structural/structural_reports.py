...
_is_structural_budget_python_path = _budget_module.is_structural_budget_python_path
_collect_facade_private_entrypoints = _budget_module.collect_facade_private_entrypoints
_normalize_file_line_exceptions = _budget_module.normalize_file_line_exceptions
_load_structural_budget_ratchet = _budget_module.load_structural_budget_ratchet
_evaluate_structural_budget_ratchet = _budget_module.evaluate_structural_budget_ratchet
_append_structural_budget_findings = _architecture_module.append_structural_budget_findings
...
_structural_entry_files = _graphs_module.structural_entry_files
_structural_report_discovery = _graphs_module.structural_report_discovery
_accumulate_dependency_graph_snapshot = _graphs_module.accumulate_dependency_graph_snapshot
_iter_snapshot_accesses_by_definition = _graphs_module.iter_snapshot_accesses_by_definition
_accumulate_call_graph_snapshot = _graphs_module.accumulate_call_graph_snapshot
_build_dependency_graph_report = _graphs_module.build_dependency_graph_report
_build_call_graph_report = _graphs_module.build_call_graph_report
_should_emit_snapshot_progress = _graphs_module.should_emit_snapshot_progress
_stream_workspace_graph_reports = _graphs_module.stream_workspace_graph_reports
_serialize_invoke_coord = _graphics_module.serialize_invoke_coord
_serialize_moduledef = _graphics_module.serialize_moduledef
_stable_json_marker = _graphics_module.stable_json_marker
_graphics_field_value = _graphics_module.graphics_field_value
_graphics_layout_group_payload = _graphics_module.graphics_layout_group_payload
_graphics_layout_entry = _graphics_module.graphics_layout_entry
_walk_graphics_layout_children = _graphics_module.walk_graphics_layout_children
_accumulate_graphics_layout_snapshot = _graphics_module.accumulate_graphics_layout_snapshot
_build_graphics_layout_report = _graphics_module.build_graphics_layout_report
