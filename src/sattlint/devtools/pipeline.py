...
_shell_command = pipeline_cli_helpers.shell_command
_changed_file_flag_args = pipeline_cli_helpers.changed_file_flag_args
_focused_python_files = pipeline_cli_helpers.focused_python_files
_owner_test_targets_for_checks = pipeline_cli_helpers.owner_test_targets_for_checks
build_change_proof_requirements = pipeline_cli_helpers.build_change_proof_requirements
_build_owner_pytest_step = pipeline_cli_helpers.build_owner_pytest_step
...
_build_finish_gate_commands = pipeline_cli_helpers.build_finish_gate_commands
