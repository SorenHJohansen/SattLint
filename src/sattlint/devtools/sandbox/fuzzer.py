...
from sattlint.devtools.artifact_registry import (
    FUZZ_RESULTS_SCHEMA_KIND as FUZZER_RESULTS_SCHEMA_KIND,
)
from sattlint.devtools.artifact_registry import (
    FUZZ_RESULTS_SCHEMA_VERSION as FUZZER_RESULTS_SCHEMA_VERSION,
)
...
class FuzzCampaignResults:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            "kind": FUZZER_RESULTS_SCHEMA_KIND,
            "schema_version": FUZZER_RESULTS_SCHEMA_VERSION,
            "summary": {
