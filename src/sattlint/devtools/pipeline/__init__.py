...
from defusedxml import ElementTree as defusedxml_ElementTree  # type: ignore[import-untyped]
...
from . import _pipeline_failure_outputs as pipeline_failure_output_helpers
from . import _pipeline_finish_gate as pipeline_finish_gate_helpers
from . import _pipeline_optional_reports_helpers as pipeline_optional_report_helpers
...
shell_command = pipeline_cli_helpers.shell_command
changed_file_flag_args = pipeline_cli_helpers.changed_file_flag_args
focused_python_files = pipeline_cli_helpers.focused_python_files
owner_test_targets_for_checks = pipeline_cli_helpers.owner_test_targets_for_checks
...
def _run_pytest_stage(
    ...
    *,
    ...
    except (FileNotFoundError, OSError, UnicodeDecodeError, defusedxml_ElementTree.ParseError) as exc:
        message = (
