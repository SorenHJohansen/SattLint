...
def run_recommended_repo_audit_slice(
    ...
    *,
    ...
    from . import _repo_audit_recommended_slice as helper  # noqa: PLC0415
    ...
    *,
    ...
    if selected_surface == "pipeline":
        ...
        selected_command_argv = [
            ...
            *entrypoints_module.changed_file_flag_args(resolved_changed_files),
            "--output-dir",
            sanitized_selected_output_dir,
        ]
    ...
    ai_feedback = entrypoints_module._build_ai_feedback_report(
        ...
        selected_command=entrypoints_module.shell_command(selected_command_argv),
