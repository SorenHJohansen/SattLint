...
is_active_output_ai_gc_path = _repo_audit_compat_module.is_active_output_ai_gc_path
filter_ai_gc_report_for_output_dir = _repo_audit_compat_module.filter_ai_gc_report_for_output_dir
filter_ai_gc_findings_for_output_dir = _repo_audit_compat_module.filter_ai_gc_findings_for_output_dir
...
find_pipeline_findings = _repo_audit_compat_module.find_pipeline_findings
_dedupe_findings = _repo_audit_compat_module._dedupe_findings
_is_leak_finding = _repo_audit_compat_module._is_leak_finding
structural_report_location_detail = _repo_audit_compat_module.structural_report_location_detail
...
run_text_scan_check = _repo_audit_check_runners_module.run_text_scan_check
run_documented_commands_check = _repo_audit_check_runners_module.run_documented_commands_check
run_unused_config_keys_check = _repo_audit_check_runners_module.run_unused_config_keys_check
run_architecture_check = _repo_audit_check_runners_module.run_architecture_check
run_structural_report_check = _repo_audit_check_runners_module.run_structural_report_check
run_cli_check = _repo_audit_check_runners_module.run_cli_check
run_logging_check = _repo_audit_check_runners_module.run_logging_check
run_ai_gc_check = _repo_audit_check_runners_module.run_ai_gc_check
run_ignored_repo_paths_check = _repo_audit_check_runners_module.run_ignored_repo_paths_check
run_coverage_check = _repo_audit_check_runners_module.run_coverage_check
_patch_doc_gardener_paths = _repo_audit_check_runners_module._patch_doc_gardener_paths
run_harness_freshness_check = _repo_audit_check_runners_module.run_harness_freshness_check
run_public_readiness_check = _repo_audit_check_runners_module.run_public_readiness_check
...
def audit_repository(
    ...
    *,
    ...
    return _audit_orchestration_module.audit_repository(
        ...
        find_pipeline_findings_fn=find_pipeline_findings,
        collect_custom_findings_fn=collect_custom_findings,
        filter_ai_gc_findings_for_output_dir_fn=filter_ai_gc_findings_for_output_dir,
        filter_ai_gc_report_for_output_dir_fn=filter_ai_gc_report_for_output_dir,
