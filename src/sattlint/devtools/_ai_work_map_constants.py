...
AGENTS_DIR = REPO_ROOT / "docs" / "maintainers" / "agents"
DEFAULT_OUTPUT_PATH = REPO_ROOT / "docs" / "maintainers" / "ai" / "ai-work-map.json"
DEFAULT_SESSION_CONTEXT_OUTPUT_PATH = REPO_ROOT / "docs" / "maintainers" / "ai" / "ai-session-context-map.json"
DEFAULT_CHECK_CATALOG_OUTPUT_PATH = REPO_ROOT / "docs" / "maintainers" / "ai" / "ai-check-catalog.md"
