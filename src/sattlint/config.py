...
_configured_targets = _config_validation_module._configured_targets
_normalize_documentation_rule_keys = _config_validation_module._normalize_documentation_rule_keys
_validation_errors_by_key = _config_validation_module._validation_errors_by_key
