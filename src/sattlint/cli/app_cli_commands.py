...
def _serialize_analyze_target_result(result: object) -> dict[str, Any]:
    return {
        ...
        "ast_cache_counts": getattr(result, "ast_cache_counts", None),
        "stage_timings_by_program_ms": getattr(result, "stage_timings_by_program_ms", None),
        "loaded_from_cache": getattr(result, "loaded_from_cache", False),
