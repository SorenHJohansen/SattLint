...
_definition_uri = _symbol_helpers._definition_uri
...
_merge_completion_items = _symbol_helpers._merge_completion_items
_merge_definitions = _symbol_helpers._merge_definitions
_merge_locations = _symbol_helpers._merge_locations
_merge_references = _symbol_helpers._merge_references
_overlay_definition_candidates = _symbol_helpers._overlay_definition_candidates
_reference_expr_at_position = _symbol_helpers._reference_expr_at_position
_reference_locations_from_matches = _symbol_helpers._reference_locations_from_matches
