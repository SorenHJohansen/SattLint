...
- **Frame Module**:
  ...
  - Uses enclosing module scope
  - Cannot be connected externally
  - Used for grouping and presentation
...
- Integer to real auto-conversion allowed
...
- Starts and ends with steps

### 12.2 Alternative Branch

- Conditional selection
- Leftmost true condition chosen
- Starts and ends with transitions
